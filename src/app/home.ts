<div class="home">
  ...
  <div id="page-contents" style="padding: 30px 0 29.1%;">
    ...
    font-size: 13px;">&nbsp;Article&nbsp;</span></h5>
              ...
              <img *ngIf="pos.media" [src]="pos?.media"   style=" margin-left: 10%;width: 500px;" class="center-align"/>
              </div>
    ...
    right: 29%;">
                    ...
                    <div class="modal-body" >
                      <img *ngIf="pos.media" [src]="pos?.media"  default="https://firebasestorage.googleapis.com/v0/b/sofiane-5a3d8.appspot.com/o/article.jpg?alt=media&token=2489a40c-f036-492b-974f-0608d3dc73ec" style="     margin-left: -2%;
    width: 974px;
    height: 330px;
    margin-top: -15px;
    margin-bottom: -20px;" class="center-align"/>
            ...
            <video *ngIf="pos.type==3&&pos.media"class="post-video" controls> <source src="{{pos?.media}}" type="video/mp4"> </video>
            <img *ngIf="pos.type==2&&pos.media" [src]="pos?.media"  default="https://firebasestorage.googleapis.com/v0/b/sofiane-5a3d8.appspot.com/o/erreur.PNG?alt=media&token=d62960c5-0a32-4a6a-97ea-e529a07741da" style=" margin-left: 10%;width: 500px;" class="center-align"/>
                    ...
                    <div class="modal-body" style="  height:495px;overflow:auto;">
                      <form>
                       <textarea #contentt  class="focus_partage" style="border: none ;  resize: none;" placeholder="Dites quelque chose a propos de ceci...">{{pos.content}}</textarea>
                        ...
                        <video *ngIf="pos.type==3&&pos.media" class="post-video" controls> <source src="{{pos?.media}}" type="video/mp4"> </video>
                        <img *ngIf="pos.type==2&&pos.media" [src]="pos?.media"  default="https://firebasestorage.googleapis.com/v0/b/sofiane-5a3d8.appspot.com/o/erreur.PNG?alt=media&token=d62960c5-0a32-4a6a-97ea-e529a07741da" style=" margin-left: 12%;width: 500px;" class="center-align"/>
